...
public class OI { 
    ...
    public OI() {
        ...
        joystickButton5.whileHeld(new Command5());
        joystickButton4 = new JoystickButton(joystick1, 1);
        joystickButton4.whileHeld(new Command4());
        joystickButton3 = new JoystickButton(joystick1, 1);
        joystickButton3.whileHeld(new Command3());
        joystickButton2 = new JoystickButton(joystick1, 1);
        joystickButton2.whileHeld(new Command2());
        ...
        SmartDashboard.putData("DriveToGear1", new DriveToGear1());
