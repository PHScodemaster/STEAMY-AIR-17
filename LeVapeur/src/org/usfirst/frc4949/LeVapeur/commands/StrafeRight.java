...
public class StrafeRight extends Command {
	// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_DECLARATIONS
	    ...
	    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_DECLARATIONS
		 public static int session;
		    ...
		    private double driveStrafeRightSpeed;
 ...
 // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public StrafeRight(double dist, double spd) {
    ...
    // Called repeatedly when this Command is scheduled to run
    		protected void execute() {
    	    	if (Robot.hasEncoders) {
    	        	...
    	        	distanceMoved = (currentTimeMillis - startTimeMillis) * driveStrafeRightSpeed * kSpeedConv;
    	    		error = distance - distanceMoved;
    	    	}
    	    	if ( error >= 0) {
    				Robot.drive.mecanumDrive(driveStrafeRightSpeed *kP, 0, 0, 0);
