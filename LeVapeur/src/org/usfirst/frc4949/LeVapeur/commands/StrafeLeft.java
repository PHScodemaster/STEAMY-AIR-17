...
private double driveStrafeLeftSpeed;
...
public StrafeLeft(double dist) {
    ...
    public StrafeLeft(double dist, double spd) {
    ...
    protected void execute() {
    	if (Robot.hasEncoders) {
        	...
        	distanceMoved = (currentTimeMillis - startTimeMillis) * driveStrafeLeftSpeed * kSpeedConv;
    		error = distance - distanceMoved;
    	}
    	if ( error >= 0) {
			Robot.drive.mecanumDrive(driveStrafeLeftSpeed *kP ,0, 0, 0);
