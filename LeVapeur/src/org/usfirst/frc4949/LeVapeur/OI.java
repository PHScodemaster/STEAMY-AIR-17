...
import org.usfirst.frc4949.LeVapeur.subsystems.*;
...
public class OI {
    ...
    public JoystickButton button_01;
    ...
    public JoystickButton button_03;
    ...
    public OI() {
        ...
        button05.whileHeld(new BoxToLeveL0());
        button04 = new JoystickButton(joystick1, 4);
        button04.whileHeld(new BoxToLevel2());
        button03 = new JoystickButton(joystick1, 3);
        button03.whileHeld(new BoxToLevel1());
        button_01 = new JoystickButton(joystick1, 1);
        button_01.whileHeld(new BallPicker());


        // SmartDashboard Buttons
        SmartDashboard.putData("Autotest1", new Autotest1());
        SmartDashboard.putData("Forward: Basic", new Forward(10, 0.65));
        ...
        SmartDashboard.putData("BoxToLeveL0", new BoxToLeveL0());
        ...
        SmartDashboard.putData("BallPicker", new BallPicker());
